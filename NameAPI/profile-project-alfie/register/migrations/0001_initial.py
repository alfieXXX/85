# Generated by Django 3.2.9 on 2022-02-04 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatedby_user_id', models.BigIntegerField(blank=True, null=True)),
                ('date_updated', models.DateTimeField(blank=True, default=None, null=True)),
                ('reference_tablestatus_fk', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='muser_tablestatus', to='register.mreference')),
            ],
        ),
    ]
